...
const INVALID_LEVEL_MESSAGE = createInterpolateElement(
	__(
		'The selected heading level may be invalid. <ExternalLink>Use appropriate heading levels to properly organize your content for visitors and search engines.</ExternalLink> See the content structure tool for more info.'
	),
	{
		ExternalLink: (
...
const INVALID_LEVEL_MESSAGE_SPOKEN = __(
	'The selected heading level may be invalid. Use appropriate heading levels to properly organize your content for visitors and search engines. See the content structure tool for more info.'
);
